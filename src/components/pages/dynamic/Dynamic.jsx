    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                sorter: true,
                render: (text, record) => {
                    return <a href={record.dynaPath} target="_blank">
                        <img src={record.dynaPath} alt="" style={{height: 110, width: 180}}/>
                    </a>
                },
                width: '20%',
            },
            ...
            //         let html = { __html: record.dynaContent };
